...
public class TestItemVenta {
	...
	EmptyArgumentException, DataFormatException {
		new ItemVenta(1, 1, "MARCA", "BOTELLA 500ML", 1, 
	...
	EmptyArgumentException, DataFormatException {
		ItemVenta iv1 = new ItemVenta(1, 1, "MARCA", "BOTELLA 500ML", 1, 
				new BigDecimal("8.00"), 12, "1234567852345");
		ItemVenta iv2 = new ItemVenta(1, 1, "MARCA", "BOTELLA 500ML", 1, 
				"Marcos", new BigDecimal("8.00"), 12);
		assertEquals(iv1, iv2);
		ItemVenta iv3 = new ItemVenta(1, 1, "MARCA", "BOTELLA 500ML", 1, 
				new BigDecimal("20.00"), 10, "1234567852345");
		assertEquals(iv1, iv3);
		ItemVenta iv4 = new ItemVenta(2, 1, "MARCA", "BOTELLA 500ML", 1, 
				new BigDecimal("20.00"), 10, "1234567852345");
		assertNotEquals(iv4, iv1);
		ItemVenta iv5 = new ItemVenta(1, 2, "MARCA", "BOTELLA 500ML", 1, 
				new BigDecimal("20.00"), 10, "1234567852345");
		assertNotEquals(iv5, iv1);
		ItemVenta iv6 = new ItemVenta(1, 1, "OTRA MARCA", "BOTELLA 500ML", 1, 
				new BigDecimal("20.00"), 10, "1234567852345");
		assertNotEquals(iv6, iv1);
		ItemVenta iv7 = new ItemVenta(1, 1, "MARCA", "OTRA BOTELLA 500ML", 1, 
				new BigDecimal("20.00"), 10, "1234567852345");
		assertNotEquals(iv7, iv1);
		ItemVenta iv8 = new ItemVenta(1, 1, "MARCA", "BOTELLA 500ML", 5, 
				new BigDecimal("20.00"), 10, "1234567852345");
