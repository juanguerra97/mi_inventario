...
throws ModelConstraintViolationException, EmptyArgumentException {
		new ItemCompra(1, 1, "MARCA", "BOTELLA 500ML", 1, 
	...
	public void testBadNumTransaccion() 
			throws ModelConstraintViolationException, EmptyArgumentException  {
		new ItemCompra(0, 1, "MARCA", "BOTELLA 500ML", 1, 
				new BigDecimal("8.00"), 12, "MIGUEL");
	}
	...
	public void testBadIdProducto() 
			throws ModelConstraintViolationException, EmptyArgumentException  {
		new ItemCompra(1, 0, "MARCA", "BOTELLA 500ML", 1, 
				new BigDecimal("8.00"), 12, "MIGUEL");
	}
	...
	public void testBadMarca() 
			throws ModelConstraintViolationException, EmptyArgumentException  {
		new ItemCompra(1, 1, "", "BOTELLA 500ML", 1, 
				new BigDecimal("8.00"), 12, "MIGUEL");
	}
	...
	public void testBadLote() 
			throws ModelConstraintViolationException, EmptyArgumentException  {
		new ItemCompra(1, 1, "MARCA", "PRESENTACION", 0, 
				new BigDecimal("8.00"), 12, "MIGUEL");
	}
	...
	public void testBadCosto() 
			throws ModelConstraintViolationException, EmptyArgumentException  {
		new ItemCompra(1, 1, "MARCA", "PRESENTACION", 1, 
				new BigDecimal("-8.00"), 12, "MIGUEL");
	}
	...
	public void testEquals() 
			throws ModelConstraintViolationException, EmptyArgumentException {
		ItemCompra ic1 = new ItemCompra(1, 1, "MARCA", "BOTELLA 500ML", 1, 
				new BigDecimal("8.00"), 12, "MIGUEL");
		ItemCompra ic2 = new ItemCompra(1, 1, "MARCA", "BOTELLA 500ML", 1, 
				new BigDecimal("10.00"), 10, "JOSE");
		assertEquals(ic1, ic2);
		ItemCompra ic3 = new ItemCompra(2, 1, "MARCA", "BOTELLA 500ML", 1, 
				new BigDecimal("8.00"), 12, "MIGUEL");
		assertNotEquals(ic3, ic1);
		ItemCompra ic4 = new ItemCompra(1, 2, "MARCA", "BOTELLA 500ML", 1, 
				new BigDecimal("8.00"), 12, "MIGUEL");
		assertNotEquals(ic4, ic1);
		ItemCompra ic5 = new ItemCompra(1, 1, "MARCA II", "BOTELLA 500ML", 1, 
				new BigDecimal("8.00"), 12, "MIGUEL");
		assertNotEquals(ic5, ic1);
		ItemCompra ic6 = new ItemCompra(1, 1, "MARCA", "LATA 500ML", 1, 
				new BigDecimal("8.00"), 12, "MIGUEL");
		assertNotEquals(ic6, ic1);
		ItemCompra ic7 = new ItemCompra(1, 1, "MARCA II", "BOTELLA 500ML", 2, 
				new BigDecimal("8.00"), 12, "MIGUEL");
