...
public class Fields {
	...
	/**
	 * Metodo para agregar un boton de limpiar a un customtextfield
	 * Este metodo es una modificacion del que se encuentra en la clase 
	 * TextFields de la libreria ControlsFX
	 * @param inputField field al que se le agregara el boton de limpiar
	 */
